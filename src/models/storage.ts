 ...
 * Storage Module | 存储模块
 *
 * Handles browser storage operations for OTP entries.
 * Supports both sync and local storage with encryption.
 *
 * 处理 OTP 条目的浏览器存储操作。
 * 支持同步存储和本地存储，并提供加密功能。
 */
...
export class BrowserStorage {
  ...
  // Use for Chrome only.
  // https://github.com/StealthChampions/Auths/issues/412
